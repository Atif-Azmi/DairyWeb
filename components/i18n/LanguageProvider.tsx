...
const dict: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "products.savedLower": "Saved in lowercase (max 64 characters). Duplicate names are not allowed.",
  ...
  hi: {
    ...
    "products.savedLower": "छोटे अक्षरों में सेव होता है (अधिकतम 64 अक्षर)। डुप्लिकेट नाम अनुमति नहीं है।",
